...
class Discriminator(nn.Module):
    def __init__(self, channels_img, features_d):
        ...
        self.net = nn.Sequential(
            ...
            # what does padding 1 correspond to?
            nn.LeakyReLU(0.2),

            nn.Conv2d(features_d, features_d * 2, kernel_size=4, stride=2, padding=1),
            # why features_d for filters? Why features_d * 2?
            nn.BatchNorm2d(features_d * 2),
            # because GANS are known for being notoriously unstable during training -- why are GANS known for this?
            nn.LeakyReLU(0.2),
